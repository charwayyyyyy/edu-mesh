      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <p className="text-base text-gray-500 dark:text-gray-400">
            Connecting Ghanaian university communities for growth and opportunity.
          </p>
        </div>
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          ...
          <div className="px-5 py-2">
            <Link to="/skills" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Skill Exchange
            </Link>
          </div>
          <div className="px-5 py-2">
        ...
        <p className="mt-8 text-center text-base text-gray-500 dark:text-gray-400">
          &copy; {new Date().getFullYear()} EduMesh. All rights reserved.
        </p>
      </div>
    </footer>
  );
